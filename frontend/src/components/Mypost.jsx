...
const Mypost = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      ...
      <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">Hey <b>{localStorage.getItem("user")}</b>! checkout your collection of imaginative and visually stunning images generated by DALL-E AI</p>
      </div>
...
const RenderCards = ({ data, title, setAllPosts }) => {
    if (data?.length > 0) {
      return (
        data.map((post) => <Card key={post._id} data={data} del={del} setAllPosts={setAllPosts} {...post} />)
      );
    }
