...
import { getRandomPrompt } from '../surpriseMe';
...
const CreatePost = () => {
  ...
  <div>
        ...
        <p className="mt-2 text-gray-600 text-[16px] max-w-[550px]">Welcome <strong>{localStorage.getItem("user")}!</strong> Generate an imaginative image through DALL-E AI and share it with the <b><Link className='hover:text-black' to="/">community</Link></b></p>
